...
#### `downloads`
An array containing RFC 3986 compliant URLs where this file may be downloaded. URIs MUST NOT contain unencoded spaces or any other illegal characters according to RFC 3986. Only URIs from the following domains are allowed:
- `cdn.modrinth.com`
- `edge.forgecdn.net` 
- `media.forgecdn.net`
- `github.com`
