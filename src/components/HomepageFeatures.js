...
const FeatureList = [
    ...
    {
        title: <Translate id="homepage.powered_rust">Powered by Rust</Translate>,
        Svg: require('../../static/img/undraw_fast_loading.svg').default,
        description: (
            <Translate id="homepage.powered_rust.desc">
